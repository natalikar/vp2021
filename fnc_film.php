<?php
	...
	function read_all_films() {
		...
		//valmistran ette SQL päringu: SELECT * FROM film
	...
	function store_film($title_input, $year_input, $duration_input, $genre_input, $studio_input, $director_input){
		$conn = new mysqli($GLOBALS["server_host"], $GLOBALS["server_user_name"], $GLOBALS["server_password"], $GLOBALS["database"]);
		$conn->set_charset("utf8");
		//SQL: INSERT INTO film (pealkiri, aasta, kestvus, zanr, tootja, lavatsaja) VALUES("Suvi", 1976, 83, "Tallinnfilm", "Arvo Kruusement")
